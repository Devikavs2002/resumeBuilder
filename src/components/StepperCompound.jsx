    ...
    switch (step) {
      case 0:
        return (
            ...
            <TextField  className="w-100" id="standard-basic" label="Fullname" variant="standard" />
      ...
      case 1:
        return (
            ...
            <TextField  className="w-100" id="standard-basic" label="Linkedin Profile Link" variant="standard" />
